...
def get_feature(feature_db: Iterable[route_guide_pb2.Feature], point: route_guide_pb2.Point) -> route_guide_pb2.Feature:
...
class RouteGuideServicer(route_guide_pb2_grpc.RouteGuideServicer):
    ...
    def GetFeature(self, request: route_guide_pb2.Point, unused_context) -> route_guide_pb2.Feature:
    ...
    async def ListFeatures(self, request: route_guide_pb2.Rectangle, unused_context) -> AsyncIterable[route_guide_pb2.Feature]:
